...
class Multi(QMainWindow, QWidget):
	...
	def initUI(self):
		...
		self.aut1()
		self.setCentralWidget(self.aut)
	def aut1(self):
		self.aut=QWidget(self)
		self.fon = QPushButton('', self.aut)
		self.fon.setIcon(QIcon('Outlast_Background_Wheelchair.jpg'))
		self.fon.setGeometry(0,-100,700,1000)
		self.fon.setIconSize(QSize(100000,10000000))

		nameText = QLabel('Введите логин', self.aut)
		nameText.move(50, 50)
		self.log = QLineEdit(self.aut)
		self.log.setGeometry(250,600,200, 40)
		
		surnameText = QLabel('Введите пароль', self.aut)
		surnameText.move(50, 90)
		self.password = QLineEdit(self.aut)
		self.password.move(50, 110)
		self.password.setGeometry(250,500,200, 40)
		
		self.button1 = QPushButton('',self.aut)
		self.button1.move(50, 120)
		self.button1.setGeometry(230,25,300, 400)
		self.button1.setIcon(QIcon('mxeb2NK.png'))
		
		self.button1.setFlat(True)
		self.button1.setIconSize(QSize(300,400))




		self.regg = QPushButton('',self.aut)
		self.regg.move(50, 120)
		self.regg.setGeometry(250,650,200, 40)
		self.regg.setIcon(QIcon('regg.png'))
		self.regg.clicked.connect(self.setForm)
		self.regg.setFlat(True)
		self.regg.setIconSize(QSize(200,50))

		self.vhod = QPushButton('',self.aut)
		self.vhod.move(50, 120)
		self.vhod.setGeometry(250,700,200, 40)
		self.vhod.setIcon(QIcon('vhod.png'))
		self.vhod.clicked.connect(self.next26)
		self.vhod.setFlat(True)
		self.vhod.setIconSize(QSize(200,50))
		
		self.loginn = QPushButton('',self.aut)
		self.loginn.move(50, 120)
		self.loginn.setGeometry(250,550,200, 40)
		self.loginn.setIcon(QIcon('parol.png'))
	
		self.loginn.setFlat(True)
		self.loginn.setIconSize(QSize(200,50))
 	

		self.paroll = QPushButton('',self.aut)
		self.paroll.move(50, 120)
		self.paroll.setGeometry(250,450,200, 40)
		self.paroll.setIcon(QIcon('login.png'))
	
		self.paroll.setFlat(True)
		self.paroll.setIconSize(QSize(200,50))
	...
	def regs(self):
		self.reg=QWidget(self)
		self.fon = QPushButton('', self.reg)
		self.fon.setIcon(QIcon('Outlast_Background_Wheelchair.jpg'))
		self.fon.setGeometry(0,-100,700,1000)
		self.fon.setIconSize(QSize(100000,10000000))

		nameText = QLabel('Введите логин', self.reg)
		nameText.move(50, 50)
		self.log = QLineEdit(self)
		self.log.setGeometry(250,600,200, 40)
		
		surnameText = QLabel('Введите пароль', self.reg)
		surnameText.move(50, 90)
		self.password = QLineEdit(self)
		self.password.move(50, 110)
		self.password.setGeometry(250,500,200, 40)
		
		self.button1 = QPushButton('',self.reg)
		self.button1.move(50, 120)
		self.button1.setGeometry(230,25,300, 400)
		self.button1.setIcon(QIcon('mxeb2NK.png'))
		...
		self.log = QLineEdit(self.reg)
		self.log.setGeometry(250,600,200, 40)


		self.password = QLineEdit(self.reg)
		self.password.move(50, 110)
		self.password.setGeometry(250,500,200, 40)
		...
		self.autoriz = QPushButton('',self.reg)
		self.autoriz.move(50, 120)
		self.autoriz.setGeometry(250,650,200, 40)
		self.autoriz.setIcon(QIcon('autoriz.png'))		
		self.autoriz.setFlat(True)
		self.autoriz.setIconSize(QSize(200,50))
		self.autoriz.clicked.connect(self.checkForm)


		
		
		
		self.loginn = QPushButton('',self.reg)
		self.loginn.move(50, 120)
		self.loginn.setGeometry(250,550,200, 40)
		self.loginn.setIcon(QIcon('parol.png'))
		...
		self.paroll = QPushButton('',self.reg)
		self.paroll.move(50, 120)
		self.paroll.setGeometry(250,450,200, 40)
		self.paroll.setIcon(QIcon('login.png'))
		...
		self.backS = QPushButton('',self.reg)
		self.backS.move(50, 120)
		self.backS.setGeometry(0,0,60,60 )
		self.backS.setIcon(QIcon('back.png'))
		self.backS.setFlat(True)
		self.backS.setIconSize(QSize(60,60))
		self.backS.clicked.connect(self.back2)
	...
	def nevern(self):
		reply = QMessageBox.question(self, 'Что-то не так',
	...
	def vern(self):
		reply = QMessageBox.question(self, 'Welcome',
			"Добро пожаловать", QMessageBox.Ok  )
